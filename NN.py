...
def nnCostFunction(nn_params, input_layer_size, hidden_layer_size, num_labels,
    ...
    Delta1 = delta2.T.dot(a1) # 25 x 401
    Delta2 = delta3.T.dot(a2) # 10 x 26
    W1_grad = Delta1 / m
    W2_grad = Delta2 / m
...
def trainNN(costFunc, nn_params, MAX_ITER=100):
    """
    ...
    for i in range(MAX_ITER):
        ...
        nn_params -= grad
        print 'Iteration\t%3d' % (i + 1), '| Cost: %f' % cost
    return nn_params
